...
import { getGoodsById } from 'apiSdk/goods';
import { GoodsInterface } from 'interfaces/goods';
import { DivergenceListPage } from 'pages/divergences';
import { InventoryListPage } from 'pages/inventories';

function GoodsViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('goods', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/goods/edit/${id}`} passHref legacyBehavior>
                    <Button
