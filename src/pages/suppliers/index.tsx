...
export function SupplierListPage(props: SupplierListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getSuppliers({
        relations: ['user', 'balance.count', 'goods.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('balance', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'balance',
          header: 'Balance',
          accessorKey: 'balance',
          cell: ({ row: { original: record } }: any) => record?._count?.balance,
        }
      : null,
    hasAccess('goods', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'goods',
          header: 'Goods',
          accessorKey: 'goods',
          cell: ({ row: { original: record } }: any) => record?._count?.goods,
        }
      : null,
