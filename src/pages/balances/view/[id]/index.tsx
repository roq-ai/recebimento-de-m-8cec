...
import { getBalanceById } from 'apiSdk/balances';
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Paid Amount" text={data?.paid_amount} />

                <FormListItem label="Due Amount" text={data?.due_amount} />

                <FormListItem
                  label="Last Payment Date"
                  text={
                    data?.last_payment_date
                      ? format(parseISO(data?.last_payment_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
                ...
                <FormListItem
                  ...
                  text={
                    data?.next_payment_date
                      ? format(parseISO(data?.next_payment_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
