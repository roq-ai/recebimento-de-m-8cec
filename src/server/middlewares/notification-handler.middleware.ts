...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'goods.create': {
    ...
    key: 'goods-received',
    tenantPath: ['supplier', 'goods'],
    userPath: [],
  },
  'balance.update': {
    roles: ['business-owner', 'inventory-manager'],
    key: 'balance-updated',
    tenantPath: ['supplier', 'balance'],
    userPath: [],
  },
  'divergence.create': {
    roles: ['business-owner', 'inventory-manager'],
    key: 'divergence-detected',
    tenantPath: ['supplier', 'goods', 'divergence'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'inventory-manager', 'goods-receiver'];
